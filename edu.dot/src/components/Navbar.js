      ...
      >
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            <span className="clr-orange font-bold text-2xl">Edu.dot</span>
          </a>
        </div>
                ...
                <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                  {callsToAction.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="flex items-center justify-center gap-x-2.5 p-3 text-sm font-bold leading-6 text-gray-900 hover:bg-gray-100"
                    >
                      <item.icon
                        className="h-5 w-5 flex-none text-gray-400"
                        aria-hidden="true"
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          ...
          <div className="ms-8 rounded-full bg-orange h-12 flex justify-center">
            <a
              href="#"
              className="my-3 mx-6 text-sm font-normal leading-6 text-white"
            >
              Sign up
            </a>
          </div>
